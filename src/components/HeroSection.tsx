...
const HeroSection = () => {
  return <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
        ...
        duration: 0.6,
        delay: 0.5
      }} className="font-body text-base text-muted-foreground italic mb-12">Graduate Certificate in Marketing . Masters of Professional Studies in Digital Media </motion.p>
